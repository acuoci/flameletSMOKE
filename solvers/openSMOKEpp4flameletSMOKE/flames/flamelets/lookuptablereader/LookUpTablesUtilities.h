...
#ifndef OpenSMOKE_LookUpTablesUtilities_H
#define OpenSMOKE_LookUpTablesUtilities_H
...
namespace OpenSMOKE
{
	class GroupOfFlamelets
	{

	public:
		std::vector<boost::filesystem::path> files;
		std::vector<double> scalar_dissipation_rates;
		std::vector<double> max_temperatures;
...
#include "LookUpTablesUtilities.hpp"

#endif // OpenSMOKE_LookUpTableUtilities_H
